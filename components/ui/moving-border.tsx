...
export function Button({
  ...
  return (
    <Component
      className={cn(
        "relative h-10 w-32 overflow-hidden bg-transparent p-[2px] text-xl",
        containerClassName,
      )}
      style={{
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn(
              "h-20 w-20 bg-[radial-gradient(#0ea5e9_40%,transparent_60%)] opacity-[0.8] blur-sm",
              borderClassName,
            )}
          />
        </MovingBorder>
...
export const MovingBorder = ({
  ...
  useAnimationFrame((time) => {
    try {
      ...
      // SVG element not yet painted — skip frame
    }
  });
